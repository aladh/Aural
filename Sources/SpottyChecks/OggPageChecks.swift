...
func testOggPage() {
    do {
        ...
        #expect((OggPageHeader.parse(page, at: page.count)) == nil, "offset past the end of the buffer fails to parse")
        ...
        #expect(
            (OggPageHeader.nextValidPage(in: falsePositiveThenRealPage.prefix(realMinimalPageOffset), from: 0)) == nil,
