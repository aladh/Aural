...
func testAuthFlow() {
    do {
        ...
        if let tokens {
            ...
            #expect((tokens.expiresAt) == (now.addingTimeInterval(3_600)), "expiry resolves against the injected clock")
        }
    ...
    do {
        ...
        #expect(
            (PKCE.codeChallenge(for: "dBjftJeZ4CVP-mB92K27uhbUJU1p1r_wW1gFWFOEjXk"))
                == ("E9Melhoa2OwvFrEMTJguCHaoeK1t8URWbuGJSstw-cM"), "PKCE challenge matches the RFC reference vector")
    }
}
