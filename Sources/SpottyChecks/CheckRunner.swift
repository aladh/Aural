...
/// and the process exit status carries the verdict. `SpottyChecks` and `SpottyBoundaryChecks`
/// share this runner and the `SpottyCheckSelection` CLI so the gate has one selection and
...
/// https://github.com/aladh/Spotty/issues/156.
