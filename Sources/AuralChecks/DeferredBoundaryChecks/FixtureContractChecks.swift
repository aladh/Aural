    ...
    check.suite("Sanitized Pathfinder response contracts") {
        ...
        check.noThrow("track search fixture decodes") {
            let response = try decoder.decode(
                ...
                from: fixture(named: "search-tracks")
            )
        ...
        check.noThrow("album fixture decodes") {
            let response = try decoder.decode(PathfinderAlbumResponse.self, from: fixture(named: "album"))
        ...
        check.noThrow("artist fixture decodes") {
            let response = try decoder.decode(PathfinderArtistResponse.self, from: fixture(named: "artist"))
        ...
        check.noThrow("home fixture decodes") {
            let response = try decoder.decode(PathfinderHomeResponse.self, from: fixture(named: "home"))
