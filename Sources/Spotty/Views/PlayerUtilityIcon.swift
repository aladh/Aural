...
struct PlaybackUtilitySymbol: Shape {
        ...
        func path(in rect: CGRect) -> Path {
            ...
            case .queue:
                ...
                path.addRoundedRect(in: CGRect(x: 1, y: 1, width: 14, height: 5), cornerSize: CGSize(width: 2.5, height: 2.5))
                path.addRoundedRect(in: CGRect(x: 2.5, y: 2.5, width: 11, height: 2), cornerSize: CGSize(width: 1, height: 1))
                path.addRect(CGRect(x: 1, y: 9, width: 14, height: 1.5))
                path.addRect(CGRect(x: 1, y: 13.5, width: 14, height: 1.5))
            case .computer:
                path.addRoundedRect(in: CGRect(x: 2, y: 1, width: 12, height: 11), cornerSize: CGSize(width: 1.75, height: 1.75))
                path.addRoundedRect(in: CGRect(x: 3.5, y: 2.5, width: 9, height: 8), cornerSize: CGSize(width: 0.25, height: 0.25))
                path.addRect(CGRect(x: 0, y: 14, width: 16, height: 1.5))
            case .devices:
                path.addRoundedRect(in: CGRect(x: 6, y: 1, width: 10, height: 14), cornerSize: CGSize(width: 1.75, height: 1.75))
                path.addRoundedRect(in: CGRect(x: 7.5, y: 2.5, width: 7, height: 11), cornerSize: CGSize(width: 0.25, height: 0.25))
