...
fn queue_snapshot_repr_c_layout_matches_header() {
    assert_eq!(std::mem::size_of::<AuralStringPair>(), 16);
    assert_eq!(std::mem::align_of::<AuralStringPair>(), 8);
    assert_eq!(std::mem::offset_of!(AuralStringPair, key), 0);
    assert_eq!(std::mem::offset_of!(AuralStringPair, value), 8);

    assert_eq!(std::mem::size_of::<AuralRestriction>(), 24);
    assert_eq!(std::mem::align_of::<AuralRestriction>(), 8);
    assert_eq!(std::mem::offset_of!(AuralRestriction, key), 0);
    assert_eq!(std::mem::offset_of!(AuralRestriction, reasons), 8);
    assert_eq!(std::mem::offset_of!(AuralRestriction, reason_count), 16);

    assert_eq!(std::mem::size_of::<AuralProtocolQueueTrack>(), 120);
    assert_eq!(std::mem::align_of::<AuralProtocolQueueTrack>(), 8);
    assert_eq!(std::mem::offset_of!(AuralProtocolQueueTrack, uri), 0);
    assert_eq!(std::mem::offset_of!(AuralProtocolQueueTrack, uid), 8);
    assert_eq!(std::mem::offset_of!(AuralProtocolQueueTrack, provider), 16);
    assert_eq!(std::mem::offset_of!(AuralProtocolQueueTrack, metadata), 24);
    assert_eq!(
        std::mem::offset_of!(AuralProtocolQueueTrack, metadata_count),
        32
    );
    assert_eq!(std::mem::offset_of!(AuralProtocolQueueTrack, removed), 40);
    assert_eq!(
        std::mem::offset_of!(AuralProtocolQueueTrack, removed_count),
        48
    );
    assert_eq!(std::mem::offset_of!(AuralProtocolQueueTrack, blocked), 56);
    assert_eq!(
        std::mem::offset_of!(AuralProtocolQueueTrack, blocked_count),
        64
    );
    assert_eq!(
        std::mem::offset_of!(AuralProtocolQueueTrack, restrictions),
        72
    );
    assert_eq!(
        std::mem::offset_of!(AuralProtocolQueueTrack, restriction_count),
        80
    );
    assert_eq!(std::mem::offset_of!(AuralProtocolQueueTrack, album_uri), 88);
    assert_eq!(
        std::mem::offset_of!(AuralProtocolQueueTrack, disallow_reasons),
        96
    );
    assert_eq!(
        std::mem::offset_of!(AuralProtocolQueueTrack, disallow_reason_count),
        104
    );
    assert_eq!(
        std::mem::offset_of!(AuralProtocolQueueTrack, artist_uri),
        112
    );

    assert_eq!(std::mem::size_of::<AuralQueueSnapshot>(), 88);
    assert_eq!(std::mem::align_of::<AuralQueueSnapshot>(), 8);
    assert_eq!(std::mem::offset_of!(AuralQueueSnapshot, revision), 0);
    assert_eq!(
        std::mem::offset_of!(AuralQueueSnapshot, session_generation),
        8
    );
    assert_eq!(std::mem::offset_of!(AuralQueueSnapshot, track_uri), 16);
    assert_eq!(std::mem::offset_of!(AuralQueueSnapshot, track_provider), 24);
    assert_eq!(std::mem::offset_of!(AuralQueueSnapshot, track_uid), 32);
    assert_eq!(std::mem::offset_of!(AuralQueueSnapshot, next_tracks), 40);
    assert_eq!(std::mem::offset_of!(AuralQueueSnapshot, next_count), 48);
    assert_eq!(std::mem::offset_of!(AuralQueueSnapshot, prev_tracks), 56);
    assert_eq!(std::mem::offset_of!(AuralQueueSnapshot, prev_count), 64);
    assert_eq!(std::mem::offset_of!(AuralQueueSnapshot, queue_revision), 72);
    assert_eq!(
        std::mem::offset_of!(AuralQueueSnapshot, disallow_set_queue),
        80
    );
    assert_eq!(
        std::mem::offset_of!(AuralQueueSnapshot, disallow_removing_from_next_tracks),
        81
    );
}
...
fn queue_snapshot_callback_copies_nullable_fields() {
    extern "C" fn capture(snapshot: *const AuralQueueSnapshot) {
    ...
    extern "C" fn capture_empty_and_nul(snapshot: *const AuralQueueSnapshot) {
        let snapshot = unsafe { &*snapshot };
...
fn queue_snapshot_getter_copies_then_frees() {
    ...
    aural_playback_free_queue_snapshot(std::ptr::null_mut());
    {
